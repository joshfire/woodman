...
define(function (require) {
   ...
   *
   * @function
   * @return {Filter} The context-wide filter. The function always returns a
   *  filter, even if the configuration does not specify one (that filter does
   *  not filter anything in practice in that case).
   */
   ...
   *
   * TODO: initialize the filters referenced by the configuration
   *
   * @function
