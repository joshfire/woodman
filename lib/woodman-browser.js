...
define(function (require) {
  ...
  var RavenAppender = require('./appenders/ravenappender');
  ...
  LogManager.registerAppender('raven', RavenAppender);
  LogManager.registerAppender('Raven', RavenAppender);
  LogManager.registerAppender('sentry', RavenAppender);
  LogManager.registerAppender('Sentry', RavenAppender);
  LogManager.registerAppender('RavenAppender', RavenAppender);
